...
def main():
    ...
    train_txt = config_proj["Input"]["userroot"] + config_proj["Input"]["data"] + config_proj["Input"]["train_set"] + "/text"
    train_feats = config_proj["Input"]["userroot"] + config_proj["Input"]["data"] + config_proj["Input"]["train_set"] +  "/feats.scp"
